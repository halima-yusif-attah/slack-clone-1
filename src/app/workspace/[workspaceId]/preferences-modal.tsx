...
function PreferencesModal({ open, setOpen, initialValue}: PreferencesModalProps) {
  ...
  const [ConfirmDialog, confirm] = UseConfirm( "Are you sure?", "This action is irrevisible");
      ...
      <DialogContent className="p-0 bg-gray-50 overflow-hidden">
        ...
        <div className="px-4 pb-4 flex flex-col gap-y-2">
          ...
          <button
            ...
            className="flex items-center gap-x-2 px-5 py-4 bg-white rounded-lg border curosr-pointer hover:bg-gray-50 text-rose-600"
          >
