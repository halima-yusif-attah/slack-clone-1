...
function Message({
    ...
    threadTimestamp,
      ...
      const [ConfirmDialog, confirm] = UseConfirm(
        "Delete message",
        "Are sure you want to delete this? This action is irreversible!"
      );
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "flexflex-col gap-2 p-1.5 px-5 hover:bg-gray-100/60 group relative",
      ...
      >
        <div className="flex items-start gap-2">
          <Hints label={formatFullTime(new Date(createdAt))}>
            <button className="text-xs text-muted-foreground opacity-0 group-hover:opacity-100 w-[40px] text-center hover:underline">
